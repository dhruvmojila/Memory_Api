          ...
          <div className="mt-4 space-y-4">
            <div>
              ...
              <p className="text-gray-600">
                Navigate to the "Add Text" or "Upload File" tab, fill in the
                required fields, and click the submit button.
              </p>
            </div>
            <div>
              <h4 className="font-semibold">How do I query my memories?</h4>
              <p className="text-gray-600">
                Go to the "Query Memory" tab, enter your question, and click
