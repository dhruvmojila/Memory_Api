...
const QueryForm = () => {
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-semibold mb-6 text-gray-800 border-b pb-4">Query Memory</h2>
      ...
      {response && (
        <div className="mt-6 p-4 bg-green-100 border border-green-200 text-green-800 rounded-lg">
          ...
          <pre className="whitespace-pre-wrap text-sm mt-2 bg-gray-50 p-3 rounded">{JSON.stringify(response.retrieved_facts, null, 2)}</pre>
        </div>
      )}
      {error && (
